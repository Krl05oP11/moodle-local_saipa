    ...
    public static function execute(int $courseid): array {
        ...
        foreach ($items as $item) {
            ...
            if (isset($response['error'])) {
                // Transport / engine failure — the rest would fail the same way.
                // Stop instead of waiting a full timeout per remaining item.
                debugging('index_course: engine error — ' . $response['error'], DEBUG_DEVELOPER);
                $enginedown = true;
                break;
            }
