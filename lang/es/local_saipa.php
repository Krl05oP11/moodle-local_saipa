...
$string['cfg_cooldown_hours_desc']   = 'Horas mínimas entre alertas consecutivas al mismo alumno. Previene la fatiga por alertas.';
...
$string['cfg_rag_global_desc']       = 'Si está habilitado, el asistente de chat recupera contexto de los materiales del curso indexados (RAG) por defecto en todos los cursos. Deshabilitarlo hace que el asistente responda solo desde el LLM base, salvo que se lo sobrescriba por curso.';
$string['cfg_retention']             = 'Retención de datos';
$string['cfg_retention_days']        = 'Días para conservar mensajes y scores de riesgo';
$string['cfg_retention_days_desc']   = 'Días que se conservan los mensajes de chat y el historial de scores de riesgo antes de eliminarse automáticamente. Relevante para el cumplimiento del GDPR.';
$string['cfg_risk_eval']             = 'Habilitar evaluación de riesgo nocturna';
$string['cfg_risk_eval_desc']        = 'Si está habilitado, una tarea programada nocturna calcula un nuevo score de riesgo de abandono para cada alumno en cada curso con SAIPA habilitado. Deshabilitarlo detiene la generación de nuevos scores en todo el sitio; los datos existentes se conservan.';
...
$string['cfg_threshold_high_desc']   = 'Alumnos con score superior a este valor se marcan como riesgo alto (badge rojo) y disparan alertas automáticas. Debe ser mayor que el umbral de riesgo medio. Recomendado: 0.65–0.80.';
$string['cfg_threshold_medium']      = 'Umbral riesgo medio (0–1)';
$string['cfg_threshold_medium_desc'] = 'Alumnos con score superior a este valor se marcan como riesgo medio (badge amarillo). Debe ser menor que el umbral de riesgo alto. Recomendado: 0.35–0.50.';
...
$string['privacy:metadata:risk_history:risk_level'] = 'La etiqueta del nivel de riesgo (bajo/medio/alto)';
$string['privacy:metadata:risk_history:score'] = 'El puntaje numérico de riesgo';
$string['privacy:metadata:risk_history:userid'] = 'El usuario cuyo riesgo fue calculado';
...
$string['privacy:metadata:saipa_risk_history'] = 'Historial de puntajes de riesgo, solo de inserción, para investigación longitudinal';
...
$string['settings:twilio_from_desc']       = 'El número emisor habilitado para WhatsApp, en el formato que exige Twilio (whatsapp:+<número>). Usá el número del Sandbox de Twilio para pruebas, o tu propio número de WhatsApp Business aprobado en producción.';
$string['settings:twilio_sid']             = 'SID de cuenta Twilio';
$string['settings:twilio_sid_desc']        = 'SID de cuenta de Twilio, lo encontrás en el panel de tu consola de Twilio. Sólo es necesario si usás Twilio como proveedor de WhatsApp.';
$string['settings:twilio_token']           = 'Token de autenticación Twilio';
$string['settings:twilio_token_desc']      = 'Token de autenticación de Twilio, lo encontrás en el panel de tu consola de Twilio. Sólo es necesario si usás Twilio como proveedor de WhatsApp.';
