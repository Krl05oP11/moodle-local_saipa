...
$string['cfg_cooldown_hours_desc']  = 'Minimum hours between consecutive alerts sent to the same student. Prevents alert fatigue.';
...
$string['cfg_rag_global_desc']      = 'When enabled, the chat assistant retrieves context from indexed course materials (RAG) by default in every course. Disabling this makes the assistant answer from the base LLM only, unless overridden per course.';
$string['cfg_retention']            = 'Data retention';
$string['cfg_retention_days']       = 'Days to retain messages and risk scores';
$string['cfg_retention_days_desc']  = 'Days to retain chat messages and risk score history before automatic deletion. Relevant for GDPR compliance.';
$string['cfg_risk_eval']            = 'Enable nightly risk evaluation';
$string['cfg_risk_eval_desc']       = 'When enabled, a nightly scheduled task computes a fresh dropout-risk score for every student in every SAIPA-enabled course. Disabling this stops new risk scores from being generated site-wide; existing data is preserved.';
...
$string['cfg_threshold_high_desc']  = 'Students with a risk score above this value are flagged as high risk (red badge) and trigger automatic alerts. Must be greater than the medium-risk threshold. Recommended: 0.65–0.80.';
$string['cfg_threshold_medium']     = 'Medium risk threshold (0–1)';
$string['cfg_threshold_medium_desc'] = 'Students with a risk score above this value are flagged as medium risk (yellow badge). Must be lower than the high-risk threshold. Recommended: 0.35–0.50.';
...
$string['settings:twilio_from_desc']  = 'The WhatsApp-enabled sender number, in Twilio\'s required format (whatsapp:+<number>). Use the Twilio Sandbox number for testing, or your own approved WhatsApp Business number in production.';
$string['settings:twilio_sid']        = 'Twilio Account SID';
$string['settings:twilio_sid_desc']   = 'Twilio Account SID, found on your Twilio Console dashboard. Required only if using Twilio as your WhatsApp provider.';
$string['settings:twilio_token']      = 'Twilio Auth Token';
$string['settings:twilio_token_desc'] = 'Twilio Auth Token, found on your Twilio Console dashboard. Required only if using Twilio as your WhatsApp provider.';
