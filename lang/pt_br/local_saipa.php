...
$string['settings:engine_url_desc']        = 'URL base do serviço saipa-engine, sem barra final (ex. https://saipa-engine.example.edu ou http://localhost:8052). Deixe vazio para desativar os recursos de IA até implantar o motor.';
